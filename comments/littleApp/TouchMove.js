...
import { Image,StyleSheet,LayoutAnimation,Text,TouchableHighlight,TouchableOpacity,PanResponder,View,ScrollView } from 'react-native';
import Util from '../../service/util';
import style from '../../service/styles'
import Icon from 'react-native-vector-icons/Ionicons';
import IconFA from 'react-native-vector-icons/FontAwesome';
const comstyle=style.styles
...
export default class extends Component{
  render() {
    return(
      <View style={[comstyle.hasHeader,comstyle.marginTop30]}>
        <Sortable />
      </View>
    )
  }
